  ...
  render() {
    return (
      <div className="container my-3">
        <h1 className="text-center" style={{fontFamily:"Cambria"}}>NewsPanda-Top {this.Capitalize(this.props.category)} Headlines</h1>
        <div className="row ">
            ...
            return (
              <div className="col-md-4 my-3" key={element.url}>
                <NewsItem
                  ...
                  imageUrl={element.url ? element.urlToImage : ""}
                  newsUrl={element.url ? element.url : ""} time={element.publishedAt} author={element.author}
                />
              </div>
            );
          })}
